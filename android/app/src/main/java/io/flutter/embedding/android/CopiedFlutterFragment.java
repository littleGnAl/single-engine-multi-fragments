 ...
 *
 * <p>Using a {@code CopiedFlutterFragment} requires forwarding a number of calls from an {@code Activity}
 ...
 *
 * <p>If convenient, consider using a {@link FlutterActivity} instead of a {@code CopiedFlutterFragment}
 * to avoid the work of forwarding calls.
 *
 * <p>{@code CopiedFlutterFragment} supports the use of an existing, cached {@link FlutterEngine}. To use
 ...
 * CopiedFlutterFragment} with the cached {@link FlutterEngine}'s ID.
 *
 ...
 *
 * <ul>
 *   <li>When {@code CopiedFlutterFragment} is in the first {@code Activity} displayed by the app, because
 ...
 */
public class CopiedFlutterFragment extends Fragment implements CopiedFlutterActivityAndFragmentDelegate.Host {
    private static final String TAG = "CopiedFlutterFragment";
    ...
    /** {@link RenderMode} to be used for the {@link FlutterView} in this {@code CopiedFlutterFragment} */
    protected static final String ARG_FLUTTERVIEW_RENDER_MODE = "flutterview_render_mode";
    /**
     * {@link TransparencyMode} to be used for the {@link FlutterView} in this {@code CopiedFlutterFragment}
     */
     ...
     * the created {@code CopiedFlutterFragment}.
     */
    protected static final String ARG_CACHED_ENGINE_ID = "cached_engine_id";
    /**
     * True if the {@link FlutterEngine} in the created {@code CopiedFlutterFragment} should be destroyed
     * when the {@code CopiedFlutterFragment} is destroyed, false if the {@link FlutterEngine} should
     * outlive the {@code CopiedFlutterFragment}.
     */
    ...
    /**
     * Creates a {@code CopiedFlutterFragment} with a default configuration.
     *
     * <p>{@code CopiedFlutterFragment}'s default configuration creates a new {@link FlutterEngine} within
     * the {@code CopiedFlutterFragment} and uses the following settings:
     *
     * <ul>
     ...
     */
    @NonNull
    public static CopiedFlutterFragment createDefault() {
        return new NewEngineFragmentBuilder().build();
    }

    /**
     * Returns a {@link NewEngineFragmentBuilder} to create a {@code CopiedFlutterFragment} with a new
    ...
    /**
     * Builder that creates a new {@code CopiedFlutterFragment} with {@code arguments} that correspond to
     * the values set on this {@code NewEngineFragmentBuilder}.
     *
     * <p>To create a {@code CopiedFlutterFragment} with default {@code arguments}, invoke {@link
     * #createDefault()}.
     *
     * <p>Subclasses of {@code CopiedFlutterFragment} that do not introduce any new arguments can use this
     * {@code NewEngineFragmentBuilder} to construct instances of the subclass without subclassing
     * this {@code NewEngineFragmentBuilder}. {@code MyCopiedFlutterFragment f = new
     * CopiedFlutterFragment.NewEngineFragmentBuilder(MyCopiedFlutterFragment.class) .someProperty(...)
     * .someOtherProperty(...) .build<MyCopiedFlutterFragment>(); }
     *
     * <p>Subclasses of {@code CopiedFlutterFragment} that introduce new arguments should subclass this
     * {@code NewEngineFragmentBuilder} to add the new properties:
     *
     * <ol>
     *   <li>Ensure the {@code CopiedFlutterFragment} subclass has a no-arg constructor.
     ...
     *       super constructor to set the {@code CopiedFlutterFragment} subclass: {@code public MyBuilder()
     *       { super(MyCopiedFlutterFragment.class); } }
     ...
     * </ol>
     *
     * Once a {@code NewEngineFragmentBuilder} subclass is defined, the {@code CopiedFlutterFragment}
     * subclass can be instantiated as follows. {@code MyCopiedFlutterFragment f = new MyBuilder()
     * .someExistingProperty(...) .someNewProperty(...) .build<MyCopiedFlutterFragment>(); }
     */
    public static class NewEngineFragmentBuilder {
        private final Class<? extends CopiedFlutterFragment> fragmentClass;
         ...
         * {@code CopiedFlutterFragment}.
         */
        public NewEngineFragmentBuilder() {
            fragmentClass = CopiedFlutterFragment.class;
        }

        /**
         * Constructs a {@code NewEngineFragmentBuilder} that is configured to construct an instance of
         * {@code subclass}, which extends {@code CopiedFlutterFragment}.
         */
        public NewEngineFragmentBuilder(@NonNull Class<? extends CopiedFlutterFragment> subclass) {
        ...
        /**
         * The initial route that a Flutter app will render in this {@link CopiedFlutterFragment}, defaults to
         * "/".
         */
        @NonNull
        ...
        /**
         * Whether or not this {@code CopiedFlutterFragment} should automatically attach its {@code Activity}
         ...
         * true then this {@code CopiedFlutterFragment} will connect its {@link FlutterEngine} to the
         ...
         * shouldAttachEngineToActivity} is false, then this {@code CopiedFlutterFragment} will not
         ...
         * CopiedFlutterFragment}'s {@link FlutterEngine} by the app developer. See {@link
         ...
         * CopiedFlutterFragment} from correctly managing the relationship between the {@link FlutterEngine}
         ...
         * {@code Activity}. For example, imagine that this {@code CopiedFlutterFragment} only takes up part
        ...
        /**
         * Creates a {@link Bundle} of arguments that are assigned to the new {@code CopiedFlutterFragment}.
         *
        ...
        /**
         * Constructs a new {@code CopiedFlutterFragment} (or a subclass) that is configured based on
         * properties set on this {@code Builder}.
         */
        @NonNull
        public <T extends CopiedFlutterFragment> T build() {
            try {
                @SuppressWarnings("unchecked")
                T frag = (T) fragmentClass.getDeclaredConstructor().newInstance();
                if (frag == null) {
                    throw new RuntimeException(
                            "The CopiedFlutterFragment subclass sent in the constructor ("
                ...
                throw new RuntimeException(
                        "Could not instantiate CopiedFlutterFragment subclass (" + fragmentClass.getName() + ")", e);
            }
        }
    }

    /**
     * Returns a {@link CachedEngineFragmentBuilder} to create a {@code CopiedFlutterFragment} with a cached
     ...
     * CopiedFlutterFragment} if a cached {@link FlutterEngine} is requested but does not exist in the
     * cache.
     *
     * <p>To create a {@code CopiedFlutterFragment} that uses a new {@link FlutterEngine}, use {@link
    ...
    /**
     * Builder that creates a new {@code CopiedFlutterFragment} that uses a cached {@link FlutterEngine}
     ...
     * Builder}. {@code MyCopiedFlutterFragment f = new
     * CopiedFlutterFragment.CachedEngineFragmentBuilder(MyCopiedFlutterFragment.class) .someProperty(...)
     * .someOtherProperty(...) .build<MyCopiedFlutterFragment>(); }
     *
     * <p>Subclasses of {@code CopiedFlutterFragment} that introduce new arguments should subclass this
     ...
     * </ol>
     *
     * Once a {@code CachedEngineFragmentBuilder} subclass is defined, the {@code CopiedFlutterFragment}
     * subclass can be instantiated as follows. {@code MyCopiedFlutterFragment f = new MyBuilder()
     * .someExistingProperty(...) .someNewProperty(...) .build<MyCopiedFlutterFragment>(); }
     */
    public static class CachedEngineFragmentBuilder {
        ...
        private CachedEngineFragmentBuilder(@NonNull String engineId) {
            this(CopiedFlutterFragment.class, engineId);
        }

        protected CachedEngineFragmentBuilder(
                @NonNull Class<? extends CopiedFlutterFragment> subclass, @NonNull String engineId) {
         ...
         * CopiedFlutterFragment} is destroyed, or {@code false} for the cached {@link FlutterEngine} to
         * outlive this {@code CopiedFlutterFragment}.
         */
        @NonNull
    ...
    // FlutterActivity and CopiedFlutterFragment. See the CopiedFlutterActivityAndFragmentDelegate
    // implementation for details about why it exists.
    @VisibleForTesting /* package */ CopiedFlutterActivityAndFragmentDelegate delegate;

    public CopiedFlutterFragment() {
     ...
     *
     * <p>The testing infrastructure should be upgraded to make CopiedFlutterFragment tests easy to write
    ...
    @VisibleForTesting
    /* package */ void setDelegate(@NonNull CopiedFlutterActivityAndFragmentDelegate delegate) {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        delegate = new CopiedFlutterActivityAndFragmentDelegate(this);
...
//        delegate.detach();
    ...
    public void onDetach() {
        ...
        if (!delegate.isDetached()) {
            delegate.onDestroyView();
            delegate.onDetach();
//            delegate.detachFromActivityIfNeeded();
            delegate.release();
            delegate = null;
        } else {
            Log.v(TAG, "CopiedFlutterFragment " + this + " onDetach called after release.");
        }
    }
    ...
    /**
     * {@link CopiedFlutterActivityAndFragmentDelegate.Host} method that is used by {@link
     * CopiedFlutterActivityAndFragmentDelegate} to obtain Flutter shell arguments when initializing
     * Flutter.
     */
    @Override
    @NonNull
     ...
     * CopiedFlutterFragment}, or {@code null} if this {@code CopiedFlutterFragment} does not want to use a cached
     * {@link FlutterEngine}.
     */
    @Nullable
    @Override
    ...
    /**
     * Returns false if the {@link FlutterEngine} within this {@code CopiedFlutterFragment} should outlive
     * the {@code CopiedFlutterFragment}, itself.
     *
    ...
    /**
     * Returns the name of the Dart method that this {@code CopiedFlutterFragment} should execute to start a
     * Flutter app.
     *
     * <p>Defaults to "main".
     *
     * <p>Used by this {@code CopiedFlutterFragment}'s {@link CopiedFlutterActivityAndFragmentDelegate.Host}
     */
    @Override
    @NonNull
     ...
     *
     * <p>By default this method defers to this {@code CopiedFlutterFragment}'s surrounding {@code
     ...
     *
     * <p>Used by this {@code CopiedFlutterFragment}'s {@link CopiedFlutterActivityAndFragmentDelegate}
     */
    @Override
    ...
    /**
     * Invoked after the {@link FlutterView} within this {@code CopiedFlutterFragment} starts rendering
    ...
    /**
     * Invoked after the {@link FlutterView} within this {@code CopiedFlutterFragment} stops rendering
     * pixels to the screen.
     *
    ...
    private boolean stillAttachedForEvent(String event) {
        if (delegate.isDetached()) {
            Log.v(TAG, "CopiedFlutterFragment " + hashCode() + " " + event + " called after release.");
            return false;
        }
        return true;
    }
    ...
    /**
     * Annotates methods in {@code CopiedFlutterFragment} that must be called by the containing {@code
     * Activity}.
     */
